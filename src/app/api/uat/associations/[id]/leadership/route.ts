// src/app/api/uat/associations/[id]/leadership/route.ts
...
export async function PUT(req: NextRequest, { params }: Params) {
  ...
  if (!["president", "administrator", "cenzor", "executiveCommittee"].includes(section)) {
  ...
  await logUATAudit({
    ...
    metadata: { section, action: "Leadership updated" },
  });
