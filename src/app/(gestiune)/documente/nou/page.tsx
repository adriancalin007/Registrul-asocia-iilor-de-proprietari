...
export default function NewDocumentPage() {
  ...
  // Load existing folders for the dropdown
  useEffect(() => {
    fetch("/api/documente?list=folders")
      .then(r => r.ok ? r.json() : [])
      .then(setFolders);
  }, []);
      ...
      <form onSubmit={handleSubmit}>
        <div className="card">
          <div className="card-body space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="input"
                />
                <p className="text-xs text-slate-400 mt-1">Data efectivă a documentului (nu data încărcării)</p>
              </div>
              <div>
            ...
            <div>
              <FileUpload
                label="Fișier document"
                hint="PDF, imagine, Word, Excel · max 20 MB"
                onUpload={(url, meta) => {
                  update("fileUrl", url);
                  if (!form.title) update("title", meta.name.replace(/\.[^.]+$/, ""));
                }}
              />
              {form.fileUrl && (
              ...
              <p className="text-xs text-slate-400 mt-1.5">
                Sau introduceți manual un URL extern (Google Drive, OneDrive etc.):
              </p>
              <input
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col justify-end">
                ...
                <p className="text-xs text-slate-400">Dacă bifat, toți proprietarii pot vedea documentul</p>
              </div>
            </div>
